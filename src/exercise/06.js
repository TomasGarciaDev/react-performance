...
function widthStateSlice(Comp, slice) {
  const MemoComp = React.memo(Comp)
  function Wrapper(props, ref) {
    const state = useAppState()
    return <MemoComp ref={ref} state={slice(state, props)} {...props} />
  }
  Wrapper.displayName = `widthStateSlice(${Comp.displayName || Comp.name})`
...
Cell = widthStateSlice(Cell, (state, {row, column}) => state.grid[row][column])
